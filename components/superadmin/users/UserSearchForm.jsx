// components/superadmin/users/UserSearchForm.jsx
import Link from "next/link";
import { Search } from "lucide-react";

/**
 * GET search form for the users list page.
 * @param {{ search: string, action?: string }} props
 */
export default function UserSearchForm({ search = "", action = "/superadmin/users" }) {
  return (
