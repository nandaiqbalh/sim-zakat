...
export default function ProgramSection() {
    return (
        <div className="space-y-8">
            ...
            {/* Mengunduh laporan distribusi */}
            <section>
                <h2 className="text-lg font-bold text-gray-800 mb-4">📄 Mengunduh Laporan Program</h2>
                <div className="space-y-4">
                    <Step number={1} title="Buka detail program setelah dibuat">
                        <p>Setiap kali Anda berada di halaman detail sebuah program, perhatikan tombol <strong>Download PDF</strong> di pojok kanan atas.</p>
                    </Step>
                    <Step number={2} title="Klik tombol Download PDF">
                        <p>Laporan akan diunduh secara otomatis dan berisi ringkasan program, konversi, distribusi, serta daftar penerima.</p>
                    </Step>
                </div>
            </section>
